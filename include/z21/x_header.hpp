...
enum struct XHeader : uint8_t {
  ...
  LAN_X_22 = 0x22u, LAN_X_DCC_READ_REGISTER = 0x22u, LAN_X_CV_READ_ALT = 0x22u,
  LAN_X_23 = 0x23u, LAN_X_DCC_WRITE_REGISTER = 0x23u, LAN_X_CV_READ = 0x23u, LAN_X_CV_WRITE_ALT = 0x23u,
